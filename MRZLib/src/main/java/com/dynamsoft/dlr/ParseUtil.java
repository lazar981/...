...
class ParseUtil {
    ...
    public static MRZResult parseTD1(String[] lineTexts) {
        ...
        if (matcher.find()) {
            mrzResult.dateOfBirth = matcher.group(4) + "-" + matcher.group(3) + "-" + matcher.group(2);
            ...
            mrzResult.dateOfExpiration = matcher.group(9) + "-" + matcher.group(8) + "-" + matcher.group(7);
    ...
    public static MRZResult parseTD2(String[] lineTexts) {
        ...
        if (matcher.find()) {
            ...
            mrzResult.dateOfBirth = matcher.group(6) + "-" + matcher.group(5) + "-" + matcher.group(4);
            ...
            mrzResult.dateOfExpiration = matcher.group(11) + "-" + matcher.group(10) + "-" + matcher.group(9);
